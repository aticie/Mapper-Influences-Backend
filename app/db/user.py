...
class UserMongoClient(BaseAsyncMongoClient):
    ...
    async def create_user(self, user_details: UserOsu):
        ...
        await self.users_collection.update_one(
            {"id": user_details.id}, {"$set": db_user}, upsert=True
        )
        return db_user
