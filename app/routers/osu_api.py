...
async def get_beatmapset(
    ...
    if type == "beatmapset" or type is None:
        return await get_beatmapset_osu_parsed(request_session, access_token, id)
    elif type == "beatmap":
        beatmap = await get_beatmap_osu_parsed(request_session, access_token, id)
        return await get_beatmapset_osu_parsed(request_session, access_token, beatmap.beatmapset_id)
    else:
        raise HTTPException(
...
async def get_user(
    ...
    return await get_user_osu_parsed(request_session, access_token, user_id)
...
async def search(
    ...
    return await search_user_osu_parsed(request_session, access_token, query)
...
async def search_map(
    ...
    return await search_map_osu_parsed(request_session, access_token, str(request.query_params))
...
async def get_beatmap_osu_parsed(session: ClientSession, access_token: str, beatmap_id: int):
...
async def get_beatmapset_osu_parsed(session: ClientSession, access_token: str, beatmapset_id: int):
...
async def get_user_osu_parsed(session: ClientSession, access_token: str, user_id: int):
...
async def search_user_osu_parsed(session: ClientSession, access_token: str, query: str):
...
async def search_map_osu_parsed(session: ClientSession, access_token: str, query: str):
